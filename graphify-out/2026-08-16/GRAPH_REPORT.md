...
Cohesion: 0.20
Nodes (12): GET(), MyriadOrderBook(), MyriadOrderBookProps, OutcomeOpt, MyriadOrderBookData, MyriadOrderBookLevel, parseLevels(), useMyriadOrderBook() (+4 more)
...
Cohesion: 0.27
Nodes (13): BASE_QUOTE_ASSETS, cashtagCounts(), engagementScore(), escapeRegExp(), extractCashtags(), hasExactCashtag(), hasHyphenatedTicker(), isOnTopicForAsset() (+5 more)
...
Cohesion: 0.18
Nodes (15): loadLatestTweetsContext(), openRouter, POST(), client, loadProjectMeta(), parseParagraphs(), POST(), ProjectMeta (+7 more)
