...
import MyriadTradingInterface from "../../_components/RexMarketsReport/RexMarketsReportData/MyriadTradingInterface";

function MyriadEventPageContent() {
  ...
  let marketSlug = rawSegment?.trim() || "";
  try {
    if (marketSlug) marketSlug = decodeURIComponent(marketSlug);
  } catch {
    /* use raw */
  }
  ...
  useOpenPilotSidebarOnMobileReportGen(marketSlug || null, setShowReportSidebar);
          ...
          >
            ...
            >
              <RexMarketsReport
                ...
                userId={currentUserId}
                selectedMarketTicker={marketSlug}
...
export default function MyriadEventPage() {
  return (
    <Suspense
      fallback={
        <div className="relative w-full h-screen flex flex-col overflow-hidden">
