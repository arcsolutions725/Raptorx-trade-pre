...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemPrompt = `
      ...
      - Include live, time-sensitive context when available
      - Add clickable markdown links to sources for current claims
    ...
    console.error("❌ Claw market follow-up failed:", error);
    return new Response(
      JSON.stringify({
